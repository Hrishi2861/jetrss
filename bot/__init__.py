...
if len(USER_SESSION_STRING) != 0:
    ...
    user = tgClient('user', TELEGRAM_API, TELEGRAM_HASH, session_string=USER_SESSION_STRING, max_concurrent_transmissions=100,
...
bot = tgClient('bot', TELEGRAM_API, TELEGRAM_HASH, bot_token=BOT_TOKEN, max_concurrent_transmissions=100,
